...
import com.kienht.materialcalendarview.format.DateFormatTitleFormatter;

import com.kienht.materialcalendarview.format.ArrayWeekDayFormatter;
import com.kienht.materialcalendarview.format.DayFormatter;
import com.kienht.materialcalendarview.format.MonthArrayTitleFormatter;
import com.kienht.materialcalendarview.format.TitleFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        titleChanger = new TitleChanger(context, title);
    ...
    public void setTypeFaceFont(Typeface font) {
        this.font = font;
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            /**
             * i = 0 khoảng cách giữa tháng và thứ. (p.height * measureTileHeight)
             * i = 1 khoảng cách giữa thứ và ngày  (p.height * measureTileHeight)
             * chiều cao của thứ và ngày bằng nhau
             * textview của thứ  setGravity(Gravity.CENTER | Gravity.BOTTOM)
             *
             */

            int childHeightMeasureSpec = MeasureSpec.makeMeasureSpec(i == 0 ? ((p.height * measureTileHeight) / 2) - 10 :
                    (p.height * measureTileHeight) + 20,
                    MeasureSpec.EXACTLY
            );
